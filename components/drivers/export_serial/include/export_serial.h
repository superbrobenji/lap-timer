 ...
 * §18.4 (`---BEGIN <name> <size>---` ... `---END <crc32 hex>---`). It also registers `dbg`, which
 * carries the 3.2-3.4 diagnostics verbs plus `crash`/`hang`/`rtc`. `list`/`open`/`read` (file
 * streaming) land in Task 5. Replaces the minimal 3.2-3.4 dbg_console.
 */
